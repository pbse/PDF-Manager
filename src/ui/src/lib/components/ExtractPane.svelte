<script lang="ts">
  ...
  let batchExtractPrompt = $state("Extract Vendor Name, Total Amount");
...
<div class="flex flex-col h-full overflow-hidden bg-white dark:bg-slate-950">
  <!-- Modern Tab Header -->
  <div class="flex items-center gap-1 p-2 bg-slate-50 dark:bg-slate-900/50 border-b border-slate-200 dark:border-slate-800">
  ...
  <div class="flex-1 overflow-hidden relative">
    ...
    {:else if activeTab === 'tools'}
      <div class="absolute inset-0 p-6 overflow-y-auto no-scrollbar space-y-8">
